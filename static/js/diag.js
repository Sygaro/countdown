...
(function () {
  ...
  async function loadNtp() {
    ...
    (function addHostPill() {
      const barRight = document.querySelector(".sysbar .right");
      if (!barRight) return; // ikke legg på body lenger
      const el = document.createElement("span");
      el.className = "sys-pill muted";
      el.textContent = location.hostname || "localhost";
      el.title = location.href;
      barRight.appendChild(el); // legg den sammen med statuslysene
    })();
  }
